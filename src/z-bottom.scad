...
module z_bottom_base(){
 ...
 translate([0,0,0]) cube([42.3+5,z_base_offset,height<=34+space ? 34+space+6 : height+6]);
 translate([0,0,0]) cube([5,42.3+z_base_offset,(height>=34+space)||(height<=34+space) ? 34+space+6 : height+6]);
...
module z_bottom_holes(){
 ...
 translate([2.5+21.3+motor_offset,z_base_offset-M6_head_height-2.5,height/2]) rotate([-90,0,0]) cylinder(r = M6_head_diameter/2, h = 20, $fn = 30);
