...
module z_bottom_base(){
 ...
 translate([2.5+21.3-4+z_motor_offset,-2,0]) cube([8,3,height]);
}
...
module z_bottom_cuts(){
 ...
 translate([2.5+21.3-15+z_motor_offset,0,-0.1]) rotate([0,0,-220]) cube([30,15,height+1]);
 translate([2.5+21.3+15+z_motor_offset,0,-0.1]) rotate([0,0,-45]) cube([15,15,height+1]); 
 ...
 translate([2.5+21.3+z_motor_offset,-3,(height-6)/2]) cube([10,6,profile_nut_width],center=true);
 
 // Seriznuti pro snazsi tisk
 if(profile_nut_width != 0)
 {
   translate([2.5+21.3+z_motor_offset - 30/2,0,(height-6)/2 + profile_nut_width/2]) rotate([180-40,0,0]) cube([30,3,8]); 
 }
}
...
module z_bottom_holes(){
 ...
 translate([2.5+21.3+z_motor_offset,z_base_offset-M6_head_height-2.5,(height-6)/2]) rotate([-90,0,0]) cylinder(r = M6_head_diameter/2, h = 20, $fn = 30);
 translate([2.5+21.3+z_motor_offset,-3,(height-6)/2]) rotate([-90,0,0]) cylinder(r = M6_dia/2, h = 20, $fn = 30);
}
